...
const jediMindTrickSmoothie = {
  name: "Jedi Mind Trick Smoothie",
  description: "A refreshing smoothie that will awaken the Force within you.",
  ingredients: [
    "1 cup Dagobah swamp berries",
    "1 banana, sliced",
    "1/2 cup Tatooine milk",
    "1 tablespoon Coruscant honey",
    "Ice cubes",
  ],
  instructions: [
...
const hothIceCreamSundae = {
  ...
  ingredients: [
    ...
    "1/4 cup Hoth chocolate sauce",
    "2 tablespoons Hoth marshmallows",
    "1 tablespoon Hoth caramel syrup",
    "1 tablespoon crushed Hoth ice",
  ],
  instructions: [
    "Scoop ice cream into a bowl or sundae glass.",
...
const tatooineSandPudding = {
  name: "Tatooine Sand Pudding",
  description:
    "A sweet and sandy dessert reminiscent of Tatooine's desert landscape.",
  ingredients: [
    "1 cup Tatooine sand (finely crushed graham crackers)",
    "2 cups Tatooine milk",
    "1/2 cup Tatooine sugar",
    "1/4 cup Mos Eisley cocoa powder",
    "1/4 cup Mos Espa butter",
    "1 teaspoon Tatooine vanilla extract",
    "Whipped cream and Tatooine cherries for garnish",
  ],
  instructions: [
    "In a saucepan, combine Tatooine milk, sugar, cocoa powder, and butter.",
    "Cook over medium heat, stirring constantly, until mixture thickens.",
    "Remove from heat and stir in vanilla extract.",
    "Layer crushed graham crackers and chocolate pudding in serving glasses.",
...
const deathStarPie = {
  name: "Death Star Pie",
  description: "A decadent pie inspired by the ultimate weapon of the Empire.",
  ingredients: [
    "1 pie crust (store-bought or homemade)",
    "1 cup crushed Oreos (for the crust)",
    ...
    "Edible silver sprinkles (for decoration)",
  ],
  instructions: [
    "Preheat oven to 350°F (175°C).",
    "Combine crushed Oreos with pie crust and press into a pie dish to form the base.",
    "Bake the crust for 10 minutes, then let it cool.",
    "In a saucepan, heat heavy cream over medium heat until it just begins to simmer.",
    "Remove from heat and add dark chocolate chips, sugar, and butter. Stir until smooth and melted.",
